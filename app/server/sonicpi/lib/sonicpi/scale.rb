  ...
  class Scale < WrappingArray
    ...
    SCALE = lambda{
      ...
      pentatonic_sequence = [3, 2, 2, 3, 2]
      {
           ...
           rast:               [2, 1.5, 1.5, 2, 2, 1.5, 1.5],
           rast_nahawand:      [2, 1.5, 1.5, 2, 2, 1, 2],
           suznak:             [2, 1.5, 1.5, 2, 1, 3, 1],
           nairuz:             [2, 1.5, 1.5, 2, 1.5, 1.5, 2],
           mahur:              [2, 1.5, 1.5, 2, 2, 2, 1],
           hijaz_kar:          [1, 3, 1, 2, 1, 3, 1],
           nawa_athar:         [2, 1, 3, 1, 1, 3, 1],
           nikriz:             [2, 1, 3, 1, 2, 1, 2],
           athar_kurd:         [1, 2, 3, 1, 1, 3, 1],
           bayati:             [1.5, 1.5, 2, 2, 1, 2, 2],
           bayati_shuri:       [1.5, 1.5, 2, 1, 3, 1, 2],
           husseini:           [1.5, 1.5, 2, 2, 1.5, 1.5, 2],
           hijaz_rast:         [1, 3, 1, 2, 1.5, 1.5, 2],
           hijaz_nahawand:     [1, 3, 1, 2, 1, 2, 2],
           zanjaran:           [1, 3, 1, 2, 2, 1, 2],
           saba:               [1.5, 1.5, 1, 3, 1, 2, 2],
           sikah_rast:         [1.5, 2, 2, 1.5, 1.5, 2, 1.5],
           sikah_nahawand:     [1.5, 2, 2, 1, 2, 2, 1.5],
           huzam:              [1.5, 2, 1, 3, 1, 2, 1.5],
