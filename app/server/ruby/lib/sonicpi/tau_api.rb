...
module SonicPi
  class TauAPI
    ...
    def link_get_next_beat_and_time_at_phase(phase, quantum)
      res = api_rpc("/link-get-next-beat-and-time-at-phase", phase, quantum)
      res
    end

    def link_get_next_beat_and_clock_time_at_phase(phase, quantum)
      beat, link_time = link_get_next_beat_and_time_at_phase(phase, quantum)
