...
module SonicPi
  module Lang
    module WesternTheory
      ...
      usage_example:  "(midi_notes :d3, :d4, :d5)",
      args:           [[:list, :array]],
      returns:        :ring,
      opts:           nil,
      accepts_block:  false,
      ...
      usage_example: "pitch_to_ratio 12",
...
(range 0, 16).each do |n|                  # For each note in the range 0->16
  ...
  sleep 0.5                                # and wait between notes
      ...
      usage_example: "ratio_to_pitch 2",
      ...
      usage_example: "set_cent_tuning! 5",
...
play 50 # Plays note 50.01"]
      ...
      summary:       "Cent tuning",
      usage_example: "use_cent_tuning 5",
...
play 50 # Plays note 50.01"]
      ...
      usage_example:  "with_cent_tuning 5 do ... end",
...
play 62 # Plays note 86"]
      ...
      usage_example: "with_octave 1 do ... end",
...
play 50 # Plays note 50"]
      ...
      usage_example: "use_transpose 12",
...
play 62 # Plays note 65"]
      ...
      usage_example:  "with_transpose 12 do ... end",
...
"]
      ...
      usage_example: "use_tuning :just, :c",
...
play 64 # Plays note 64"]
      ...
      usage_example: "with_tuning :just, :c do ... end",
...
play :e4 # Plays note 64"]
      ...
      usage_example: "current_transpose",
...
puts current_transpose # Print out the current transpose value"]
      ...
      usage_example: "current_cent_tuning",
...
"]
      ...
      usage_example:  "(note_range :e2, :e3)",
...
# returns #<SonicPi::Note :C2>}]
      ...
      usage_example:      "degree(2, :c3, :major)",
...
"]
      ...
      usage_example: "(chord_degree :i, :a3, :major)",
...
"]
      ...
      usage_example: "(chord_invert (chord :a3, :major), 1)",
