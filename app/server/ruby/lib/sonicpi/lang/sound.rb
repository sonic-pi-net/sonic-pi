        ...
        base.instance_exec do
          define_method(:initialize) do |*splat, &block|
            ...
            buf_lookup = lambda do |name, duration=nil|
              ...
              duration ||= 8
              raise ArgumentError, "Buffer duration should be a numerical value greater than zero. You inputted: #{duration}" unless duration.is_a?(Numeric) && duration.positive?
