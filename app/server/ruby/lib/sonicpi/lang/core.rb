...
"]
      ...
      doc name:           :with_swing,
          ...
          usage_example:  "with_swing 0.1 do ... end",
...
"
      ...
      doc name:           :tuplets,
          ...
          usage_example:  "tuplets [70, [72, 72], 70] do |n| ... end",
...
"tuplets [70, [72, 72], 70, [82, 82, 82]], swing: 0.2 do |n|
  play n          # plays 70,
      ...
      doc name:           :run_file,
          ...
          usage_example:  "run_file \"/path/to/code.rb\"",
          args:           [[:filename, :path]],
          returns:        nil,
          opts:           nil,
          accepts_block:  false,
...
run_file \"~/path/to/sonic-pi-code.rb\" #=> will run the contents of this file"]
      ...
      doc name:           :run_code,
          ...
          usage_example:  "run_code \"play 70\"",
          args:           [[:code, :string]],
          returns:        nil,
          opts:           nil,
          accepts_block:  false,
...
run_code \"8.times do\nplay 60\nsleep 1\nend\" # will play 60 8 times"]
      ...
      doc name:           :eval_file,
          ...
          usage_example:  "eval_file \"/path/to/code.rb\"",
          args:           [[:filename, :path]],
          returns:        nil,
          opts:           nil,
          accepts_block:  false,
...
eval_file \"~/path/to/sonic-pi-code.rb\" #=> will run the contents of this file"]
      ...
      doc name:          :use_osc_logging,
          ...
          usage_example: "use_osc_logging false",
      ...
      doc name:          :with_osc_logging,
          ...
          usage_example: "with_osc_logging false do ... end",
  ...
  "]
      ...
      doc name:           :use_osc,
          ...
          usage_example:  "use_osc \"localhost\", 7000",
...
",
      ...
      doc name:           :with_osc,
          ...
          usage_example:  "with_osc \"localhost\", 7000 do ... end",
          args:           [[:hostname, :string], [:port, :number]],
          returns:        nil,
          opts:           nil,
          accepts_block:  true,
...
"        ]
      ...
      doc name:           :osc_send,
          ...
          usage_example:  "osc_send \"localhost\", 7000, \"/hello/world\", 1",
...
"        ]
      ...
      doc name:           :osc,
          ...
          usage_example:  "osc \"/hello/world\", 1",
          args:           [[:path, :arguments]],
          returns:        nil,
          opts:           nil,
          accepts_block:  false,
...
at do
  ...
  puts tick               #=> 0
      ...
      doc name:           :time_warp,
          ...
          usage_example:  "time_warp 0.5 do ... end",
...
Given a list of times, run the block once after waiting each given time. If passed an optional params list, will pass each param individually to each block call. If size of params list is smaller than the times list, the param values will act as rings (rotate through). If the block is given 1 arg, the times are fed through. If the block is given 2 args, both the times and the params are fed through (or the time and the index if no params list was given).
  ...
  live_loop :bar       # live loop :bar will continue looping
    ...
    sleep 0.25
      ...
      doc name:           :on,
          ...
          usage_example:  "on one_in(2) do ... end",
...
on lambda{[true, false].choose} do
  ...
  "
      ...
      doc name:           :line,
          ...
          usage_example:  "(line 0, 4, steps: 4)",
...
live_loop :foo do
  ...
  sleep 0.125
      ...
      doc name:           :pick,
          ...
          usage_example:  "pick [1, 2, 3, 4, 5], 3",
...
play 80      # This is *never* played as the program is trapped in the loop above"]
      ...
      doc name:           :live_loop,
          ...
          usage_example:  "live_loop :drums do ... end",
          args:           [[:name, :symbol]],
...
live_loop :bar do             # Start a live loop called :foo which will emit a :bar
  ...
  sleep 0.5                   # Live loop :foo therefore starts and also inherits the
      ...
      doc name:           :block_duration,
          ...
          usage_example:  "block_duration do ... end",
...
puts dur #=> Returns 1.5 as 1.5 seconds have passed within the block
      ...
      doc name:           :block_slept?,
          ...
          usage_example:  "block_slept? do ... end",
...
"
  ...
  puts version.patch # => Prints out the patch level for this version such as 0"]
      ...
      doc name:           :spark_graph,
          ...
          usage_example:  "spark_graph (range 1, 5)",
          args:           [],
          opts:           nil,
          accepts_block:  false,
  ...
  "spark (range 1, 5).shuffle #=> ▄▇▆▁▃"
      ...
      doc name:           :defonce,
          ...
          usage_example:  "defonce :bar do ... end",
          args:           [[:name, :symbol]],
  ...
  play bar # plays 80"]
      ...
      doc name:           :ndefine,
          ...
          usage_example:  "ndefine :beep do ... end",
          args:           [[:name, :symbol]],
          opts:           nil,
          accepts_block:  true,
          requires_block: true,
      ...
      doc name:           :define,
          introduced:     Version.new(2,0,0),
          summary:        "Define a new function",
          usage_example:  "define :beep do ... end",
          args:           [[:name, :symbol]],
          opts:           nil,
          accepts_block:  true,
          requires_block: true,
...
Note, it is not recommended to start a function name with a capital letter if it takes no parameters.",
  ...
  comment do # starting a block level comment:
    ...
    play 62 # not played
      ...
      doc name:           :uncomment,
          ...
          usage_example:  "uncomment do ... end",
          args:           [],
          opts:           nil,
          accepts_block:  true,
          requires_block: true,
  ...
  uncomment do # starting a block level comment:
    ...
    play 62 # played
      ...
      doc name:          :print,
          ...
          usage_example: "print \"hello there\"",
  ...
  "print foo             #=> will print the contents of foo to the output pane"]
      ...
      doc name:           :puts,
          introduced:     Version.new(2,0,0),
          summary:        "Display a message in the output pane",
          usage_example:  "puts \"hello there\"",
          args:           [[:output, :anything]],
          opts:           nil,
          accepts_block:  false,
          intro_fn:       true,
  ...
  factor?(2, 0.5) #true - 2 is a multiple of 0.5 (0.5 * 4 = 2) "
      ...
      doc name:           :quantise,
          ...
          usage_example:  "quantise 0.68, 0.25",
...
print rand_i_look(5) # will print either 0, 1, 2, 3, or 4 to the output pane"
  ...
  shuffle \"foobar\"  #=> Would return something like: \"roobfa\""    ]
      ...
      doc name:          :use_random_seed,
          ...
          usage_example: "use_random_seed 2000",
  ...
  "  ]
      ...
      doc name:           :with_random_seed,
          ...
          usage_example:  "with_random_seed 2000 do ... end",
  ...
  "
      ...
      doc name:           :use_random_source,
          ...
          usage_example:  "use_random_source :pink",
...
You can see the 'buckets' that the numbers between 0 and 1 fall into with the following code:
  ...
  puts rand # => 0.597015380859375
      ...
      doc name:           :with_random_source,
          ...
          usage_example:  "with_random_source :pink do ... end",
  ...
  puts rand # => 0.597015380859375
      ...
      doc name:          :use_cue_logging,
          ...
          usage_example: "use_cue_logging false",
      ...
      doc name:          :with_cue_logging,
          ...
          usage_example: "with_cue_logging false do ... end",
...
"      ]
      ...
      usage_example: "set_link_bpm! 120",
  ...
  live_loop :clk do
    ...
    sleep 1
      ...
      doc name:           :with_bpm,
          ...
          usage_example:  "with_bpm 120 do ... end",
  ...
  * Drum and bass: 160-180 bpm
  ...
  4.times do
    ...
    sleep 1 # sleeps for 1 second
      ...
      doc name:           :with_bpm_mul,
          ...
          usage_example:  "with_bpm_mul 0.5 do ... end",
  ...
  "]
      ...
      doc name:           :density,
          ...
          usage_example:  "density 2 do ... end",
...
"]
      ...
      doc name:          :current_random_seed,
          ...
          usage_example: "current_random_seed",
...
"]
      ...
      doc name:          :current_random_source,
          ...
          usage_example: "current_random_source",
...
"]
      ...
      doc name:          :current_bpm_mode,
          ...
          usage_example: "current_bpm_mode",
...
This can be set via the fns `use_bpm`, `with_bpm`, `use_sample_bpm` and `with_sample_bpm`.",
  ...
  puts current_bpm    # => 120 (or whatever the current Link BPM value is)"]
      ...
      doc name:          :current_beat_duration,
          ...
          usage_example: "current_beat_duration",
...
"]
      ...
      doc name:          :use_sched_ahead_time,
          ...
          usage_example: "use_sched_ahead_time 1",
...
",
      ...
      doc name:          :with_real_time,
          ...
          usage_example: "with_real_time do ... end",
          doc:           "
...
play 70  # Sound will happen with the default latency (0.5s)."]
      ...
      doc name:          :with_sched_ahead_time,
          ...
          usage_example: "with_sched_ahead_time 1 do ... end",
...
"
      ...
      doc name:          :current_sched_ahead_time,
          ...
          usage_example: "current_sched_ahead_time",
  ...
  in_thread do
    loop do                    # In the main thread, just loop
      ...
      doc name:           :in_thread,
          ...
          usage_example:  "in_thread do ... end",
...
",
  ...
  "    ]
      ...
      doc name:           :assert_error,
          ...
          usage_example:  "assert_error do pley 70 end",
...
"]
      ...
      doc name:           :assert_not_equal,
          ...
          usage_example:  "assert_not_equal 1, 5",
...
" ]
      ...
      doc name:           :assert_equal,
          ...
          usage_example:  "assert_equal (1 + 1), 2",
...
" ]
      ...
      doc name:           :assert_similar,
          ...
          usage_example:  "assert_similar 4.9999999999, 5.0",
...
assert_similar(4.9999999999, 5.0) #=> True"
      ...
      doc name:           :load_buffer,
          ...
          usage_example:  "load_buffer \"/path/to/code.rb\"",
...
load_buffer \"~/sonic-pi-tracks/phat-beats.rb\" # will replace content of current buffer with contents of the file"]
      ...
      doc name:           :load_example,
          ...
          usage_example:  "load_example :rerezzed",
