...
print rand_i_look(5) #=> will print the same number as the previous statement"
  ...
  "
      ...
      :perlin is a special kind of noise which produces smooth slopes. Large jumps are much less likely and you will tend to see lots of smooth motion going either up or down
      ...
      ",
          examples:       ["
  use_random_type :white # use white noise as the distribution (default)
  use_random_seed 1 # reset random seed to 1
  puts rand # => 0.733917236328125
  puts rand  #=> 0.464202880859375
  use_random_seed 1 # reset it back to 1
  use_random_type :pink # use pink noise as the distribution
  puts rand # => 0.464202880859375
  puts rand # => 0.445465087890625
  use_random_seed 1 # reset it back to 1
  use_random_type :perlin # use perlin noise as the distribution
  puts rand # => 0.521209716796875
  puts rand # => 0.531524658203125

  with_random_type :white do # reset seed back to 1 just for this block
    puts rand # => 0.733917236328125
    puts rand #=> 0.464202880859375
  end
