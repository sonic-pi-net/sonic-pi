    ...
    : QsciAbstractAPIs(lexer)
{
  ...
  keywords[SampleParam] << "amp:" << "pan:" << "attack:" << "decay:" << "sustain:" << "release:" << "attack_level:" << "sustain_level:" << "env_curve:" << "rate:" << "beat_stretch:" << "start:" << "finish:" << "res:" << "cutoff:" << "norm:" << "pitch:" << "window_size:" << "pitch_dis:" << "time_dis:";
}
