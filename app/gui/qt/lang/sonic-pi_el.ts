...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Χρησιμοποιήστε αυτόν τον ολισθητή για να αλλάξετε την ένταση του συστήματος.</translation>
    </message>
    <message>
...
external PA systems when performing with Sonic Pi.</source>
        <translation type="unfinished">Ρυθμίσεις ήχου για προχωρημένους για
...
be routed to the right speaker and visa versa.</source>
        <translation type="unfinished">Αντιστροφή στερεοφωνίας
...
can only handle mono.</source>
        <translation type="unfinished">Μονοφωνική κατάσταση.
...
που μπορούν να διαχειριστούν μόνο μονοφωνικό σήμα.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Αλλαγή συμπεριφοράς συνθέσεων και ηχητικών εφέ</translation>
    </message>
    <message>
...
create unexpectedly loud or uncomfortable sounds.</source>
        <translation type="unfinished">Εναλλαγή λειτουργιών ελέγχου παραμέτρων συνθέσεων.
...
even when a little late.</source>
        <translation type="unfinished">Όταν ενεργοποιηθεί, το Sonic Pi θα αρνηθεί
...
ακόμη κι&apos; αν είναι λίγο αργά.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Ενεργοποίηση εξωτερικών συνθέσεων και ηχητικών εφέ</translation>
    </message>
    <message>
...
which isn&apos;t recognised.</source>
        <translation type="unfinished">Όταν ενεργοποιηθεί, το Sonic Pi θα επιτρέπει
...
to and from other programs or computers
 via the currently connected network.</source>
        <translation type="unfinished">Το Sonic Pi μπορεί να στείλει μηνύματα Ανοιχτού Ελέγχου Ήχου (OSC)
...
μέσω του τωρινά συνδεδεμένου δικτύου.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Ακούω για μηνύματα OSC στην θύρα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Λήψη απομακρυσμένων μηνυμάτων OSC</translation>
    </message>
    <message>
 ...
 When unchecked, only messages from the local machine will be received.</source>
        <translation type="unfinished">Όταν ενεργοποιηθεί, το Sonic Pi θα ακούει για μηνύματα OSC από απομακρυσμένες μηχανές.
 Όταν απενεργοποιηθεί, μόνο μηνύματα από την τοπική μηχανή θα λαμβάνονται.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Ενεργοποίηση διακομιστή OSC</translation>
    </message>
    <message>
 ...
 When unchecked no OSC messages will be received.</source>
        <translation type="unfinished">Όταν ενεργοποιηθεί, το Sonic Pi θα ακούει για μηνύματα OSC.
 Όταν απενεργοποιηθεί, δεν θα λαμβάνονται μηνύματα OSC.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Ενεργοποίηση υποσυστημάτων MIDI</translation>
    </message>
    <message>
        ...
        <translation type="unfinished">Ενεργοποίηση ή απενεργοποίηση εισερχόμενης και εξερχόμενης επικοινωνίας MIDI</translation>
    </message>
    <message>
        <location filename="../widgets/settingswidget.cpp" line="186"/>
        <source>Reset MIDI</source>
        <translation type="unfinished">Επαναφορά MIDI</translation>
    </message>
    <message>
...
(Απαραίτητο για την ανίχνευση αλλαγών στο macOS)</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Προεπιλεγμένο κανάλι MIDI (το * σημαίνει όλα)</translation>
    </message>
    <message>
        ...
        <translation type="unfinished">Προεπιλεγμένο κανάλι MIDI για την αποστολή μυνημάτων σε</translation>
    </message>
    <message>
...
(similar to incoming OSC messages and internal cues)</source>
        <translation type="unfinished">Οι συσκευές εισαγωγής MIDI στέλνουν μηνύματα MIDI απευθείας στο
...
Sonic Pi which can be sent via the midi_* fns</source>
        <translation type="unfinished">Οι συσκευές εξαγωγής MIDI λαμβάνουν μηνύματα MIDI απευθείας από
το Sonic Pi τα οποία μπορούν να σταλθούν με τις συναρτήσεις midi_*</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Όψη και Αίσθηση</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ρυθμίσεις λειτουργιών αυτοματισμού.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Αυτόματη διάταξη του κώδικα στην εκτέλεση</translation>
    </message>
    <message>
...
triggering will not be printed to the log by default.</source>
        <translation type="unfinished">Ενεργοποίηση/ Απενεργοποίηση αρχείου καταγραφής.
...
time the run button is pressed.</source>
        <translation type="unfinished">Εκκαθάριση αρχείου καταγραφής κατά την εκτέλεση.
...
However, they will not be visible in the logs.</source>
        <translation type="unfinished">Ενεργοποίηση ή απενεργοποίηση καταγραφής των cues.
...
If enabled the log is scrolled to the bottom after every new message is displayed.</source>
        <translation type="unfinished">Ορισμός αυτόματης ολίσθησης αρχείου καταγραφής.
Εάν ενεργοποιηθεί το αρχείο καταγραφής μετακινείται στο κάτω μέρος όταν ένα νέο μήνυμα εμφανίζεται.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Εμφάνιση αξόνων</translation>
    </message>
    <message>
        ...
        <translation type="unfinished">Εναλλαγή της ορατότητας των αξόνων για τα παλμοσκόπια ήχου</translation>
    </message>
    <message>
...
Stereo - shows two independent scopes for left and right channels</source>
        <translation type="unfinished">Το παλμοσκόπιο ήχου έχει τρεις εκδοχές που μπορούν να
...
This check involves sending anonymous information about your platform and version.</source>
        <translation type="unfinished">Ενεργοποίηση ελέγχου αυτόματων ενημερώσεων.
...
This check involves sending anonymous information about your platform and version.</source>
        <translation type="unfinished">Εξαναγκασμένος έλεγχος για ενημερώσεις τώρα.
Αυτός ο έλεγχος συμπεριλαμβάνει την αποστολή ανώνυμων πληροφοριών σχετικά με την πλατφόρμα και την έκδοσή του προγράμματος.</translation>
    </message>
    <message>
