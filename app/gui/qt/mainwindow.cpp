...
void MainWindow::changeTheme(){
  ...
  if(dark_mode->isChecked()){
    ...
    prefsWidget->setStyleSheet(QString("QGroupBox{font-size: 11px;} QDockWidget *{color: %3;} QDockWidget::title{font: bold 2px; color: %3; border-bottom: 1px solid %2; text-align: center; background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 %1, stop: 1.0 #1c2529);} QCheckBox *{color: #000;}").arg(windowColor, windowBorder, windowForegroundColor));
