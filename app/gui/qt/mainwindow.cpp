...
QListWidgetItem *lang_item_1 = new QListWidgetItem("define");
lang_item_1->setData(32, QVariant("<h2><pre>define<pre></h2><h2><pre>[name (symbol)]</pre></h2><h3>Define a function</h3>"));
langNameList->addItem(lang_item_1);

QListWidgetItem *lang_item_2 = new QListWidgetItem("print");
lang_item_2->setData(32, QVariant("<h2><pre>print<pre></h2><h2><pre>[output (string)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_2);

QListWidgetItem *lang_item_3 = new QListWidgetItem("puts");
lang_item_3->setData(32, QVariant("<h2><pre>puts<pre></h2><h2><pre>[output (string)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_3);

QListWidgetItem *lang_item_4 = new QListWidgetItem("rand");
lang_item_4->setData(32, QVariant("<h2><pre>rand<pre></h2><h2><pre>[]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_4);

QListWidgetItem *lang_item_5 = new QListWidgetItem("rrand");
lang_item_5->setData(32, QVariant("<h2><pre>rrand<pre></h2><h2><pre>[min (number), max (number)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_5);

QListWidgetItem *lang_item_6 = new QListWidgetItem("rrand_i");
lang_item_6->setData(32, QVariant("<h2><pre>rrand_i<pre></h2><h2><pre>[min (number), max (number)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_6);

QListWidgetItem *lang_item_7 = new QListWidgetItem("choose");
lang_item_7->setData(32, QVariant("<h2><pre>choose<pre></h2><h2><pre>[list (array)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_7);

QListWidgetItem *lang_item_8 = new QListWidgetItem("use_bpm");
lang_item_8->setData(32, QVariant("<h2><pre>use_bpm<pre></h2><h2><pre>[bpm (number)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_8);

QListWidgetItem *lang_item_9 = new QListWidgetItem("with_bpm");
lang_item_9->setData(32, QVariant("<h2><pre>with_bpm<pre></h2><h2><pre>[]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_9);

QListWidgetItem *lang_item_10 = new QListWidgetItem("sleep");
lang_item_10->setData(32, QVariant("<h2><pre>sleep<pre></h2><h2><pre>[seconds (number)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_10);

QListWidgetItem *lang_item_11 = new QListWidgetItem("sync");
lang_item_11->setData(32, QVariant("<h2><pre>sync<pre></h2><h2><pre>[sync_id (symbol)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_11);

QListWidgetItem *lang_item_12 = new QListWidgetItem("wait");
lang_item_12->setData(32, QVariant("<h2><pre>wait<pre></h2><h2><pre>[sync_id (symbol)]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_12);

QListWidgetItem *lang_item_13 = new QListWidgetItem("in_thread");
lang_item_13->setData(32, QVariant("<h2><pre>in_thread<pre></h2><h2><pre>[]</pre></h2><h3></h3>"));
langNameList->addItem(lang_item_13);

QListWidgetItem *lang_item_14 = new QListWidgetItem("set_sched_ahead_time!");
lang_item_14->setData(32, QVariant("<h2><pre>set_sched_ahead_time!<pre></h2><h2><pre>[time (number)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_14);

QListWidgetItem *lang_item_15 = new QListWidgetItem("use_debug");
lang_item_15->setData(32, QVariant("<h2><pre>use_debug<pre></h2><h2><pre>[true_or_false (boolean)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_15);

QListWidgetItem *lang_item_16 = new QListWidgetItem("with_debug");
lang_item_16->setData(32, QVariant("<h2><pre>with_debug<pre></h2><h2><pre>[true_or_false (boolean)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_16);

QListWidgetItem *lang_item_17 = new QListWidgetItem("use_arg_checks");
lang_item_17->setData(32, QVariant("<h2><pre>use_arg_checks<pre></h2><h2><pre>[true_or_false (boolean)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_17);

QListWidgetItem *lang_item_18 = new QListWidgetItem("with_arg_checks");
lang_item_18->setData(32, QVariant("<h2><pre>with_arg_checks<pre></h2><h2><pre>[true_or_false (boolean)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_18);

QListWidgetItem *lang_item_19 = new QListWidgetItem("use_transpose");
lang_item_19->setData(32, QVariant("<h2><pre>use_transpose<pre></h2><h2><pre>[note_shift (number)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_19);

QListWidgetItem *lang_item_20 = new QListWidgetItem("with_transpose");
lang_item_20->setData(32, QVariant("<h2><pre>with_transpose<pre></h2><h2><pre>[note_shift (number)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_20);

QListWidgetItem *lang_item_21 = new QListWidgetItem("use_synth");
lang_item_21->setData(32, QVariant("<h2><pre>use_synth<pre></h2><h2><pre>[synth_name (symbol)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_21);

QListWidgetItem *lang_item_22 = new QListWidgetItem("with_synth");
lang_item_22->setData(32, QVariant("<h2><pre>with_synth<pre></h2><h2><pre>[synth_name (symbol)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_22);

QListWidgetItem *lang_item_23 = new QListWidgetItem("recording_start");
lang_item_23->setData(32, QVariant("<h2><pre>recording_start<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_23);

QListWidgetItem *lang_item_24 = new QListWidgetItem("recording_stop");
lang_item_24->setData(32, QVariant("<h2><pre>recording_stop<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_24);

QListWidgetItem *lang_item_25 = new QListWidgetItem("recording_save");
lang_item_25->setData(32, QVariant("<h2><pre>recording_save<pre></h2><h2><pre>[path (string)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_25);

QListWidgetItem *lang_item_26 = new QListWidgetItem("recording_delete");
lang_item_26->setData(32, QVariant("<h2><pre>recording_delete<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_26);

QListWidgetItem *lang_item_27 = new QListWidgetItem("play");
lang_item_27->setData(32, QVariant("<h2><pre>play<pre></h2><h2><pre>[note (symbol_or_number)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_27);

QListWidgetItem *lang_item_28 = new QListWidgetItem("play_pattern");
lang_item_28->setData(32, QVariant("<h2><pre>play_pattern<pre></h2><h2><pre>[notes (list)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_28);

QListWidgetItem *lang_item_29 = new QListWidgetItem("play_pattern_timed");
lang_item_29->setData(32, QVariant("<h2><pre>play_pattern_timed<pre></h2><h2><pre>[notes (list), times (list)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_29);

QListWidgetItem *lang_item_30 = new QListWidgetItem("play_chord");
lang_item_30->setData(32, QVariant("<h2><pre>play_chord<pre></h2><h2><pre>[notes (list)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_30);

QListWidgetItem *lang_item_31 = new QListWidgetItem("repeat");
lang_item_31->setData(32, QVariant("<h2><pre>repeat<pre></h2><h2><pre>[notes (list)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_31);

QListWidgetItem *lang_item_32 = new QListWidgetItem("use_merged_synth_defaults");
lang_item_32->setData(32, QVariant("<h2><pre>use_merged_synth_defaults<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_32);

QListWidgetItem *lang_item_33 = new QListWidgetItem("with_merged_synth_defaults");
lang_item_33->setData(32, QVariant("<h2><pre>with_merged_synth_defaults<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_33);

QListWidgetItem *lang_item_34 = new QListWidgetItem("use_synth_defaults");
lang_item_34->setData(32, QVariant("<h2><pre>use_synth_defaults<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_34);

QListWidgetItem *lang_item_35 = new QListWidgetItem("with_synth_defaults");
lang_item_35->setData(32, QVariant("<h2><pre>with_synth_defaults<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_35);

QListWidgetItem *lang_item_36 = new QListWidgetItem("with_fx");
lang_item_36->setData(32, QVariant("<h2><pre>with_fx<pre></h2><h2><pre>[fx_name (symbol)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_36);

QListWidgetItem *lang_item_37 = new QListWidgetItem("use_sample_pack");
lang_item_37->setData(32, QVariant("<h2><pre>use_sample_pack<pre></h2><h2><pre>[pack_path (string)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_37);

QListWidgetItem *lang_item_38 = new QListWidgetItem("current_bpm");
lang_item_38->setData(32, QVariant("<h2><pre>current_bpm<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_38);

QListWidgetItem *lang_item_39 = new QListWidgetItem("set_volume!");
lang_item_39->setData(32, QVariant("<h2><pre>set_volume!<pre></h2><h2><pre>[vol (number)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_39);

QListWidgetItem *lang_item_40 = new QListWidgetItem("load_sample");
lang_item_40->setData(32, QVariant("<h2><pre>load_sample<pre></h2><h2><pre>[path (string)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_40);

QListWidgetItem *lang_item_41 = new QListWidgetItem("load_samples");
lang_item_41->setData(32, QVariant("<h2><pre>load_samples<pre></h2><h2><pre>[paths (list)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_41);

QListWidgetItem *lang_item_42 = new QListWidgetItem("sample_info");
lang_item_42->setData(32, QVariant("<h2><pre>sample_info<pre></h2><h2><pre>[path (string)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_42);

QListWidgetItem *lang_item_43 = new QListWidgetItem("sample_duration");
lang_item_43->setData(32, QVariant("<h2><pre>sample_duration<pre></h2><h2><pre>[path (string)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_43);

QListWidgetItem *lang_item_44 = new QListWidgetItem("sample");
lang_item_44->setData(32, QVariant("<h2><pre>sample<pre></h2><h2><pre>[name_or_path (symbol_or_string)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_44);

QListWidgetItem *lang_item_45 = new QListWidgetItem("status");
lang_item_45->setData(32, QVariant("<h2><pre>status<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_45);

QListWidgetItem *lang_item_46 = new QListWidgetItem("note");
lang_item_46->setData(32, QVariant("<h2><pre>note<pre></h2><h2><pre>[note (symbol_or_number)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_46);

QListWidgetItem *lang_item_47 = new QListWidgetItem("note_info");
lang_item_47->setData(32, QVariant("<h2><pre>note_info<pre></h2><h2><pre>[note (symbol_or_number)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_47);

QListWidgetItem *lang_item_48 = new QListWidgetItem("scale");
lang_item_48->setData(32, QVariant("<h2><pre>scale<pre></h2><h2><pre>[tonic (symbol), name (symbol)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_48);

QListWidgetItem *lang_item_49 = new QListWidgetItem("chord");
lang_item_49->setData(32, QVariant("<h2><pre>chord<pre></h2><h2><pre>[tonic (symbol), name (symbol)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_49);

QListWidgetItem *lang_item_50 = new QListWidgetItem("control");
lang_item_50->setData(32, QVariant("<h2><pre>control<pre></h2><h2><pre>[node (synth_node)]</pre></h2><h3>add docs</h3>"));
langNameList->addItem(lang_item_50);

QListWidgetItem *lang_item_51 = new QListWidgetItem("sample_groups");
lang_item_51->setData(32, QVariant("<h2><pre>sample_groups<pre></h2><h2><pre>[]</pre></h2><h3>add docs</h3>"));
...
QListWidgetItem *samples_item_93 = new QListWidgetItem("Drum Sounds");
samples_item_93->setData(32, QVariant("<h2>Drum Sounds</h2><h2><pre>:drum_</pre></h2><ul><li><pre>:drum_heavy_kick</pre></li><li><pre>:drum_tom_mid_soft</pre></li><li><pre>:drum_tom_mid_hard</pre></li><li><pre>:drum_tom_lo_soft</pre></li><li><pre>:drum_tom_lo_hard</pre></li><li><pre>:drum_tom_hi_soft</pre></li><li><pre>:drum_tom_hi_hard</pre></li><li><pre>:drum_splash_soft</pre></li><li><pre>:drum_splash_hard</pre></li><li><pre>:drum_snare_soft</pre></li><li><pre>:drum_snare_hard</pre></li><li><pre>:drum_cymbal_soft</pre></li><li><pre>:drum_cymbal_hard</pre></li><li><pre>:drum_cymbal_open</pre></li><li><pre>:drum_cymbal_closed</pre></li><li><pre>:drum_cymbal_pedal</pre></li><li><pre>:drum_bass_soft</pre></li><li><pre>:drum_bass_hard</pre></li></ul>"));
samplesNameList->addItem(samples_item_93);

QListWidgetItem *samples_item_94 = new QListWidgetItem("Electric Sounds");
samples_item_94->setData(32, QVariant("<h2>Electric Sounds</h2><h2><pre>:elec_</pre></h2><ul><li><pre>:elec_triangle</pre></li><li><pre>:elec_snare</pre></li><li><pre>:elec_lo_snare</pre></li><li><pre>:elec_hi_snare</pre></li><li><pre>:elec_mid_snare</pre></li><li><pre>:elec_cymbal</pre></li><li><pre>:elec_soft_kick</pre></li><li><pre>:elec_filt_snare</pre></li><li><pre>:elec_fuzz_tom</pre></li><li><pre>:elec_chime</pre></li><li><pre>:elec_bong</pre></li><li><pre>:elec_twang</pre></li><li><pre>:elec_wood</pre></li><li><pre>:elec_pop</pre></li><li><pre>:elec_beep</pre></li><li><pre>:elec_blip</pre></li><li><pre>:elec_blip2</pre></li><li><pre>:elec_ping</pre></li><li><pre>:elec_bell</pre></li><li><pre>:elec_flip</pre></li><li><pre>:elec_tick</pre></li><li><pre>:elec_hollow_kick</pre></li><li><pre>:elec_twip</pre></li><li><pre>:elec_plip</pre></li><li><pre>:elec_blup</pre></li></ul>"));
samplesNameList->addItem(samples_item_94);

QListWidgetItem *samples_item_95 = new QListWidgetItem("Sounds featuring guitars");
samples_item_95->setData(32, QVariant("<h2>Sounds featuring guitars</h2><h2><pre>:guit_</pre></h2><ul><li><pre>:guit_harmonics</pre></li><li><pre>:guit_e_fifths</pre></li><li><pre>:guit_e_slide</pre></li></ul>"));
samplesNameList->addItem(samples_item_95);

QListWidgetItem *samples_item_96 = new QListWidgetItem("Miscellaneous Sounds");
samples_item_96->setData(32, QVariant("<h2>Miscellaneous Sounds</h2><h2><pre>:misc_</pre></h2><ul><li><pre>:misc_burp</pre></li></ul>"));
samplesNameList->addItem(samples_item_96);

QListWidgetItem *samples_item_97 = new QListWidgetItem("Percurssive Sounds");
samples_item_97->setData(32, QVariant("<h2>Percurssive Sounds</h2><h2><pre>:perc_</pre></h2><ul><li><pre>:perc_bell</pre></li></ul>"));
samplesNameList->addItem(samples_item_97);

QListWidgetItem *samples_item_98 = new QListWidgetItem("Ambient Sounds");
samples_item_98->setData(32, QVariant("<h2>Ambient Sounds</h2><h2><pre>:ambi_</pre></h2><ul><li><pre>:ambi_soft_buzz</pre></li><li><pre>:ambi_swoosh</pre></li><li><pre>:ambi_drone</pre></li><li><pre>:ambi_glass_hum</pre></li><li><pre>:ambi_glass_rub</pre></li><li><pre>:ambi_haunted_hum</pre></li><li><pre>:ambi_piano</pre></li><li><pre>:ambi_lunar_land</pre></li><li><pre>:ambi_dark_woosh</pre></li><li><pre>:ambi_choir</pre></li></ul>"));
samplesNameList->addItem(samples_item_98);

QListWidgetItem *samples_item_99 = new QListWidgetItem("Bass Sounds");
samples_item_99->setData(32, QVariant("<h2>Bass Sounds</h2><h2><pre>:bass_</pre></h2><ul><li><pre>:bass_hit_c</pre></li><li><pre>:bass_hard_c</pre></li><li><pre>:bass_thick_c</pre></li><li><pre>:bass_drop_c</pre></li><li><pre>:bass_woodsy_c</pre></li><li><pre>:bass_voxy_c</pre></li><li><pre>:bass_voxy_hit_c</pre></li><li><pre>:bass_dnb_f</pre></li></ul>"));
samplesNameList->addItem(samples_item_99);

QListWidgetItem *samples_item_100 = new QListWidgetItem("Sounds for Looping");
samples_item_100->setData(32, QVariant("<h2>Sounds for Looping</h2><h2><pre>:loop_</pre></h2><ul><li><pre>:loop_industrial</pre></li><li><pre>:loop_compus</pre></li><li><pre>:loop_amen</pre></li><li><pre>:loop_amen_full</pre></li></ul>"));
samplesNameList->addItem(samples_item_100);
