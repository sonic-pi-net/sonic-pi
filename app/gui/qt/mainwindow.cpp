...
QListWidgetItem *samples_item_44 = new QListWidgetItem("Drum Sounds");
samples_item_44->setData(32, QVariant("<h2>Drum Sounds</h2><h2><pre>:drum_</pre></h2><ul><li><pre>:drum_heavy_kick</pre></li><li><pre>:drum_tom_mid_soft</pre></li><li><pre>:drum_tom_mid_hard</pre></li><li><pre>:drum_tom_lo_soft</pre></li><li><pre>:drum_tom_lo_hard</pre></li><li><pre>:drum_tom_hi_soft</pre></li><li><pre>:drum_tom_hi_hard</pre></li><li><pre>:drum_splash_soft</pre></li><li><pre>:drum_splash_hard</pre></li><li><pre>:drum_snare_soft</pre></li><li><pre>:drum_snare_hard</pre></li><li><pre>:drum_cymbal_soft</pre></li><li><pre>:drum_cymbal_hard</pre></li><li><pre>:drum_cymbal_open</pre></li><li><pre>:drum_cymbal_closed</pre></li><li><pre>:drum_cymbal_pedal</pre></li><li><pre>:drum_bass_soft</pre></li><li><pre>:drum_bass_hard</pre></li></ul>"));
samplesNameList->addItem(samples_item_44);

QListWidgetItem *samples_item_45 = new QListWidgetItem("Electric Sounds");
samples_item_45->setData(32, QVariant("<h2>Electric Sounds</h2><h2><pre>:elec_</pre></h2><ul><li><pre>:elec_triangle</pre></li><li><pre>:elec_snare</pre></li><li><pre>:elec_lo_snare</pre></li><li><pre>:elec_hi_snare</pre></li><li><pre>:elec_mid_snare</pre></li><li><pre>:elec_cymbal</pre></li><li><pre>:elec_soft_kick</pre></li><li><pre>:elec_filt_snare</pre></li><li><pre>:elec_fuzz_tom</pre></li><li><pre>:elec_chime</pre></li><li><pre>:elec_bong</pre></li><li><pre>:elec_twang</pre></li><li><pre>:elec_wood</pre></li><li><pre>:elec_pop</pre></li><li><pre>:elec_beep</pre></li><li><pre>:elec_blip</pre></li><li><pre>:elec_blip2</pre></li><li><pre>:elec_ping</pre></li><li><pre>:elec_bell</pre></li><li><pre>:elec_flip</pre></li><li><pre>:elec_tick</pre></li><li><pre>:elec_hollow_kick</pre></li><li><pre>:elec_twip</pre></li><li><pre>:elec_plip</pre></li><li><pre>:elec_blup</pre></li></ul>"));
samplesNameList->addItem(samples_item_45);

QListWidgetItem *samples_item_46 = new QListWidgetItem("Sounds featuring guitars");
samples_item_46->setData(32, QVariant("<h2>Sounds featuring guitars</h2><h2><pre>:guit_</pre></h2><ul><li><pre>:guit_harmonics</pre></li><li><pre>:guit_e_fifths</pre></li><li><pre>:guit_e_slide</pre></li></ul>"));
samplesNameList->addItem(samples_item_46);

QListWidgetItem *samples_item_47 = new QListWidgetItem("Miscellaneous Sounds");
samples_item_47->setData(32, QVariant("<h2>Miscellaneous Sounds</h2><h2><pre>:misc_</pre></h2><ul><li><pre>:misc_burp</pre></li></ul>"));
samplesNameList->addItem(samples_item_47);

QListWidgetItem *samples_item_48 = new QListWidgetItem("Percurssive Sounds");
samples_item_48->setData(32, QVariant("<h2>Percurssive Sounds</h2><h2><pre>:perc_</pre></h2><ul><li><pre>:perc_bell</pre></li></ul>"));
samplesNameList->addItem(samples_item_48);

QListWidgetItem *samples_item_49 = new QListWidgetItem("Ambient Sounds");
samples_item_49->setData(32, QVariant("<h2>Ambient Sounds</h2><h2><pre>:ambi_</pre></h2><ul><li><pre>:ambi_soft_buzz</pre></li><li><pre>:ambi_swoosh</pre></li><li><pre>:ambi_drone</pre></li><li><pre>:ambi_glass_hum</pre></li><li><pre>:ambi_glass_rub</pre></li><li><pre>:ambi_haunted_hum</pre></li><li><pre>:ambi_piano</pre></li><li><pre>:ambi_lunar_land</pre></li><li><pre>:ambi_dark_woosh</pre></li><li><pre>:ambi_choir</pre></li></ul>"));
samplesNameList->addItem(samples_item_49);

QListWidgetItem *samples_item_50 = new QListWidgetItem("Bass Sounds");
samples_item_50->setData(32, QVariant("<h2>Bass Sounds</h2><h2><pre>:bass_</pre></h2><ul><li><pre>:bass_hit_c</pre></li><li><pre>:bass_hard_c</pre></li><li><pre>:bass_thick_c</pre></li><li><pre>:bass_drop_c</pre></li><li><pre>:bass_woodsy_c</pre></li><li><pre>:bass_voxy_c</pre></li><li><pre>:bass_voxy_hit_c</pre></li><li><pre>:bass_dnb_f</pre></li></ul>"));
samplesNameList->addItem(samples_item_50);

QListWidgetItem *samples_item_51 = new QListWidgetItem("Sounds for Looping");
samples_item_51->setData(32, QVariant("<h2>Sounds for Looping</h2><h2><pre>:loop_</pre></h2><ul><li><pre>:loop_industrial</pre></li><li><pre>:loop_compus</pre></li><li><pre>:loop_amen</pre></li><li><pre>:loop_amen_full</pre></li></ul>"));
samplesNameList->addItem(samples_item_51);
