...
void MainWindow::loadMacShortcuts()
{
    ...
    shortcutMap["Info"] = resolveShortcut("Meta+n");
    ...
    shortcutMap["Tab1"] = resolveShortcut("Meta+1");
    shortcutMap["Tab2"] = resolveShortcut("Meta+2");
    shortcutMap["Tab3"] = resolveShortcut("Meta+3");
    shortcutMap["Tab4"] = resolveShortcut("Meta+4");
    shortcutMap["Tab5"] = resolveShortcut("Meta+5");
    shortcutMap["Tab6"] = resolveShortcut("Meta+6");
    shortcutMap["Tab7"] = resolveShortcut("Meta+7");
    shortcutMap["Tab8"] = resolveShortcut("Meta+8");
    shortcutMap["Tab9"] = resolveShortcut("Meta+9");
    shortcutMap["Tab0"] = resolveShortcut("Meta+0");
