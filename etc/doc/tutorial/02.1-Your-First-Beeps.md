...
OK, enough of the intros - let's get into some sound. Take a look at the
following code:
...
Remember to put the colon `:` in front of of your note name so that it
goes pink. Also, you can specify the octave by adding a number after the
note name:
