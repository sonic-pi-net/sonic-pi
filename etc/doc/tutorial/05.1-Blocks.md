...
We therefore need to tell Sonic Pi where we wish to *start* our
meaningful thing and where to *end* it. We use `do` for start and `end`
for end. For example:
...
your code with `do` and `end` tells Sonic Pi you wish to do something
